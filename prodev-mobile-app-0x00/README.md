...
The app was successfully scaffolded, modified, run on a physical device, and reset for reuse while the default content generated by Expo were moved into `app-example`